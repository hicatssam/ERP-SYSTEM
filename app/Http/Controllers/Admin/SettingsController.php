...
class SettingsController extends Controller
{
    private const VALUE_KEYS = [
        ...
        'customer_menu_intro_subtitle','customer_menu_intro_cta','customer_menu_intro_show_logo',
        'customer_menu_primary_color','customer_menu_accent_color','customer_menu_background_color',
        'customer_menu_surface_color','customer_menu_text_color','customer_menu_muted_color','customer_menu_border_color',
        'customer_menu_content_width','customer_menu_section_gap','customer_menu_product_card_radius',
        'customer_menu_product_card_shadow','customer_menu_nav_style','customer_menu_font_family',
        'customer_menu_card_image_ratio','customer_menu_image_fit','customer_menu_show_featured',
        'customer_menu_featured_title','customer_menu_featured_limit','customer_menu_cover_overlay',
        'customer_menu_show_search','customer_menu_show_categories','customer_menu_show_descriptions',
        'customer_menu_checkout_button_text','customer_menu_status_toast_enabled','customer_menu_status_sound_enabled',
        'customer_menu_show_team','customer_menu_team_limit','customer_menu_team_title','customer_menu_team_subtitle',
        'customer_menu_team_card_style','customer_menu_show_footer','customer_menu_footer_text',
        ...
        'customer_menu_status_received_title','customer_menu_status_received_message',
        'customer_menu_status_accepted_title','customer_menu_status_accepted_message',
        'customer_menu_status_preparing_title','customer_menu_status_preparing_message',
        'customer_menu_status_ready_title','customer_menu_status_ready_message',
        'customer_menu_status_completed_title','customer_menu_status_completed_message',
        'customer_menu_status_cancelled_title','customer_menu_status_cancelled_message',
        'customer_menu_allow_dine_in','customer_menu_allow_takeaway','customer_menu_allow_outdoor','customer_menu_allow_delivery',
        'customer_menu_default_prep_minutes','customer_menu_queue_minutes_per_order',
    ...
    public function update(Request $request, ModuleService $modules)
    {
        ...
        $request->validate([
            ...
            */
            ...
            'customer_menu_enabled' => ['nullable', 'boolean'],
            'customer_menu_experience_preset' => ['nullable', Rule::in(['restaurant', 'cafe', 'bakery', 'minimal'])],
            'customer_menu_title' => ['nullable', 'string', 'max:100'],
            'customer_menu_subtitle' => ['nullable', 'string', 'max:180'],
            'customer_menu_intro_mode' => ['nullable', Rule::in(['off', 'first_visit', 'always'])],
            'customer_menu_intro_align' => ['nullable', Rule::in(['center', 'right'])],
            'customer_menu_intro_eyebrow' => ['nullable', 'string', 'max:80'],
            'customer_menu_intro_title' => ['nullable', 'string', 'max:120'],
            'customer_menu_intro_subtitle' => ['nullable', 'string', 'max:220'],
            'customer_menu_intro_cta' => ['nullable', 'string', 'max:60'],
            'customer_menu_intro_show_logo' => ['nullable', 'boolean'],
            'customer_menu_primary_color' => $hex,
            'customer_menu_accent_color' => $hex,
            'customer_menu_background_color' => $hex,
            'customer_menu_surface_color' => $hex,
            'customer_menu_text_color' => $hex,
            'customer_menu_muted_color' => $hex,
            'customer_menu_border_color' => $hex,
            'customer_menu_content_width' => ['nullable', 'integer', 'min:360', 'max:1700'],
            'customer_menu_section_gap' => ['nullable', 'integer', 'min:20', 'max:100'],
            'customer_menu_product_card_radius' => ['nullable', 'integer', 'min:0', 'max:40'],
            'customer_menu_product_card_shadow' => ['nullable', Rule::in(['none', 'soft', 'deep'])],
            'customer_menu_nav_style' => ['nullable', Rule::in(['floating', 'solid'])],
            'customer_menu_font_family' => ['nullable', Rule::in(['Cairo', 'Tajawal'])],
            'customer_menu_card_image_ratio' => ['nullable', Rule::in(['4-3', '1-1', '3-4'])],
            'customer_menu_image_fit' => ['nullable', Rule::in(['cover', 'contain'])],
            'customer_menu_show_featured' => ['nullable', 'boolean'],
            'customer_menu_featured_title' => ['nullable', 'string', 'max:100'],
            'customer_menu_featured_limit' => ['nullable', 'integer', 'min:2', 'max:8'],
            'customer_menu_cover_overlay' => ['nullable', 'integer', 'min:0', 'max:90'],
            'customer_menu_show_search' => ['nullable', 'boolean'],
            'customer_menu_show_categories' => ['nullable', 'boolean'],
            'customer_menu_show_descriptions' => ['nullable', 'boolean'],
            'customer_menu_checkout_button_text' => ['nullable', 'string', 'max:80'],
            'customer_menu_status_toast_enabled' => ['nullable', 'boolean'],
            'customer_menu_status_sound_enabled' => ['nullable', 'boolean'],
            'customer_menu_show_team' => ['nullable', 'boolean'],
            'customer_menu_team_limit' => ['nullable', 'integer', 'min:1', 'max:12'],
            'customer_menu_team_title' => ['nullable', 'string', 'max:100'],
            'customer_menu_team_subtitle' => ['nullable', 'string', 'max:180'],
            'customer_menu_team_card_style' => ['nullable', Rule::in(['portrait', 'compact'])],
            'customer_menu_show_footer' => ['nullable', 'boolean'],
            'customer_menu_footer_text' => ['nullable', 'string', 'max:220'],
            'customer_menu_showcase_enabled' => ['nullable', 'boolean'],
            'customer_menu_showcase_dark_color' => $hex,
            'customer_menu_showcase_eyebrow' => ['nullable', 'string', 'max:100'],
            'customer_menu_showcase_title' => ['nullable', 'string', 'max:140'],
            'customer_menu_showcase_subtitle' => ['nullable', 'string', 'max:260'],
            'customer_menu_showcase_primary_cta' => ['nullable', 'string', 'max:60'],
            'customer_menu_showcase_secondary_cta' => ['nullable', 'string', 'max:60'],
            'customer_menu_showcase_height' => ['nullable', 'integer', 'min:560', 'max:900'],
            'customer_menu_showcase_diagonal_depth' => ['nullable', 'integer', 'min:40', 'max:180'],
            'customer_menu_showcase_show_info_cards' => ['nullable', 'boolean'],
            'customer_menu_showcase_show_category_strip' => ['nullable', 'boolean'],

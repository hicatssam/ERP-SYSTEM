...
/* Checkout guidance + payment-proof AI explanation. */
(function(){
 const form=document.getElementById('checkoutForm');
 if(form&&!document.querySelector('.checkout-flow')){
   const flow=document.createElement('div');flow.className='checkout-flow';flow.innerHTML='<span><i class="fa-solid fa-user"></i> بياناتك</span><span><i class="fa-solid fa-credit-card"></i> الدفع</span><span><i class="fa-solid fa-check"></i> التأكيد</span>';form.parentNode.insertBefore(flow,form);
 }

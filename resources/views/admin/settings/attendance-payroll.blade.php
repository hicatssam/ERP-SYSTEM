    ...
    <div class="att-settings-head">
        <div>
            ...
            <p class="page-subheading">
                التحكم بتفعيل الحضور، أجهزة البصمة وسياسات تأثير الدوام على الرواتب.
            </p>
        </div>
    </div>
        ...
        <div class="att-settings-grid">
            ...
            <div class="att-setting-card">
                <div class="att-setting-head">
                    ...
                    <div>
                        <h3>أجهزة البصمة</h3>
                        <p>تفعيل Connector / Push ومعالجة بصمات الأجهزة.</p>
                    </div>
                </div>
                ...
                <div class="att-setting-body">
                    <div class="att-toggle-row">
                        <div class="att-toggle-copy">
                            <strong>تفعيل تكامل أجهزة البصمة</strong>
                            <small>
                                يخفي شاشة الأجهزة ويمنع جميع Device Push Endpoints عند إيقافه.
                            </small>
                        </div>

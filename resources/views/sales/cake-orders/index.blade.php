...
@media(max-width:800px){.cake-hero{align-items:flex-start;flex-direction:column}.cake-create-btn{width:100%;justify-content:center}.cake-summary{grid-template-columns:repeat(2,minmax(0,1fr))}.cake-grid{grid-template-columns:1fr}.cake-order-card{grid-template-columns:108px minmax(0,1fr)}}
